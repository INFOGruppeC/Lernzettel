 ...
 * eine
 * Gewichtung als double uebergeben. Beide Knotenobjekte koennen abgefragt
 * werden.
 * Des Weiteren koennen die Gewichtung und eine Markierung gesetzt und abgefragt
 * werden.
 * </p>
 * 
...
public class Edge {
  ...
  /**
   * Die Anfrage gibt die beiden Knoten, die durch die Kante verbunden werden, als
   * neues Feld vom Typ Vertex zurueck. Das Feld hat
  ...
  /**
   * Die Anfrage liefert true, wenn die Markierung der Kante den Wert true hat,
   * ansonsten false.
   */
